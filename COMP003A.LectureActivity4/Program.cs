...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] simpleArray = new string[] { "eleifend", "donec", "pretium", "vulputate", "sapien", "nec", "sagittis", "aliquam", "malesuade", "bibendum" };

            // enumerate the elements of a collection and executes its body for each element of the collection
             ...
             *  Boolean expression evaluates to true. Because that expressiom is evaluated after
             ...
             *  statements differs from a do loop, which executes one or more times.
             */
